...
main path: gcc/ubuntu/22.04/rv64gcv0p7/config.yaml
:::
...
config_file: repo_url: <https://github.com/ruyisdk/ruyici.git> branch:
main path: gcc/openeuler/23.03/rv64gcv0p7/config.yaml
:::
:::
...
``` bash
ruyibuild init -d rv64gcv0p7 -f rv64gcv0p7.yaml
```
