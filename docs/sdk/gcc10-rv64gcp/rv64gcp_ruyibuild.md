...
main path: gcc/ubuntu/22.04/rv64gcp/config.yaml
:::
...
config_file: repo_url: <https://github.com/ruyisdk/ruyici.git> branch:
main path: gcc/openeuler/23.03/rv64gcp/config.yaml
:::
:::
...
``` bash
ruyibuild init -d rv64gcp -f rv64gcp.yaml
```
